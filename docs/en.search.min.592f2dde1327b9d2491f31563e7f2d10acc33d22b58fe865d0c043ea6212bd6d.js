...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.2ab3dbcad1557c831a4571c48a74786395977eccef6fd10af636526393b8829f.js',function(){input.required=false;search();});}
