...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.f14d1eeb98408031cdc27172f0b9538c656008fb6e99f2c62a2676abe785b19d.js',function(){input.required=false;search();});}
