...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/Programmer-Interview-Checklist/flexsearch.min.js');loadScript('/Programmer-Interview-Checklist/en.search-data.min.fc812d4796b32848889ebb9ac3d797cc08c0f15a957e85cb93529bbe91b81a03.js',function(){input.required=false;search();});}
