...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.5b4d671f8d439800de341016576518c05fff6278f2ac07ff18fd42d9b95b9e71.js',function(){input.required=false;search();});}
