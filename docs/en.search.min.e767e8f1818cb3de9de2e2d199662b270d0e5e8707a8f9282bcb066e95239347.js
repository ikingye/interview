...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.4bcc47a1cea8c0c6178cad24250915203247698604c3590539f89a58daaa1449.js',function(){input.required=false;search();});}
