...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.86da9a3ea2b46cf0f6d87a09e6bca7f59a2ee5711e6dec89d3daaf87afeb6dae.js',function(){input.required=false;search();});}
