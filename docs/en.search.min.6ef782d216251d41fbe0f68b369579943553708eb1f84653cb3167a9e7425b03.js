...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.06dd0259f6f676fd80da846223fd7079e6ff3d072d4ac7507dad70e3378deee4.js',function(){input.required=false;search();});}
