...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.fb81501f066f4236e500a991eaf7abe734672aa8a1882cbae96b6b5e5a9db830.js',function(){input.required=false;search();});}
