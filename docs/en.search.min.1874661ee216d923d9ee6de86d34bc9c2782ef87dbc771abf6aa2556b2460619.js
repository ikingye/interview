...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.b9147b02938adcc2dd469cb78f26a953e72128901572e5b43b4ef6da580673c4.js',function(){input.required=false;search();});}
