...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.b2ccf7ae73dd2903e4c341a6c516bdd24a1b8721cd70b469b0caeaab8be5a814.js',function(){input.required=false;search();});}
